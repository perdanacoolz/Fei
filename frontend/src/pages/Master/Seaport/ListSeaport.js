...
import CreateEditSeaport from './CreateEditSeaport';
...
const ListSeaport = () => {
  ...
  return (
    <>
      ...
      <CreateEditSeaport isModal={isModal} handleClick={handleClick} titleModal={titleModal} title={title} param={param} id={id}
