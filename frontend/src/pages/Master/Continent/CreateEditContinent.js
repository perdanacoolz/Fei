...
const CreateEditContinent = ({ isModal, handleClick, titleModal, title, param, id ,masterCode,abbreviation,name,code }) => {
    ...
    React.useEffect(() => {
        ...
        setName2(name);
        setCode2(code);
    }, [masterCode,abbreviation,name,code])
...
export default CreateEditContinent